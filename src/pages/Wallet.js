            ...
            <div className="App" >
                ...
                <Box className={classes.root}>
                    ...
                    <Typography>
                        ...
                        of the recipient's phone, especially the Wallet on their phone.  The idea here is to test the issuing server.
            </Typography>
                    <Box {...sectionProps} bgcolor={getBackgroundColor(1)}>
                        <Typography variant="h5" gutterBottom>Step 1 - Initiate Exchange</Typography>
                    {getStepMessage(1)}
                        <Typography  gutterBottom>
                            At this point in the exchange (the beginning), a link will have been given (e.g., emailed) to the student, like the link below (note the query params on the link).
                            The student would click this link (in the email) while on their phone, which would send the request to the issuer's server to start the issuance exchange.  The link
                            will likely first take the student to some authentication page (and so open a web browser on the phone). After authentication the issuer will 
                            generate a one time token/challenge, maybe verify the user is entitled to a credential, and then redirect
                            the request to the redirect_uri that was included as a query parameter on the original link, adding on two additional query parameters to that link:
                        </Typography>
                        <Box display="flex" justifyContent="center" m={1} p={1} >
                            ...
                            <Typography  gutterBottom>
                            Normally the redirect_uri would be a deep link that opens the Wallet on the recipient's phone, but in this case is a link that opens this page.
                            So, make the 'redirect_uri' point to this page (rather than a deep link), like in the example url below.
                            Change the example url below to match what you need, e.g., change the server location to yours, 
                            possibly the link in the redirect_uri (if you are say hosting a copy of this page), and
                    ...
                    <Typography gutterBottom>Okay then, we (the Wallet) have now constructed our signed Verifiable Presentation (as shown below).
                        ...
                        the recipient is in fact entitled to a certificate, construct it, sign it, and send it back.
                    </Typography>
                        <Box p={3}>
